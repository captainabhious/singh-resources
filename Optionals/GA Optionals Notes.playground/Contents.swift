...
/*:
 ...
 ```
 */
var optionalStringTwo: String? = "Richard"
//optionalStringTwo = nil
//if let username = optionalStringTwo {
//  print("My usename is :\(username) and it exists!!")
//} else {
//  print("Go to login screen... you need to log in")
//}

  print("My usename is :\(optionalStringTwo) and it exists!!")
/*:
